    ...
    <div class="row">
        <div class="col s12 m12 l12 TestBox1">
            ...
            <div class="row s6 m6 l6 TestBox1">
                ...
                <asp:MultiView ID="mView" runat="server" ActiveViewIndex="0" Visible="false">
                    <asp:View ID="vPI" runat="server">
                        หมายเลข PI :
                        <asp:Label ID="lbPINo" runat="server"></asp:Label><br />
                        จำนวน :
            ...
            <asp:Label ID="lbgroup3" runat="server"></asp:Label>
                <br />
                หมายเหตุ : กรณีขนส่งไปรษณีย์ ระบบจะคิดค่าขนส่งไปรษณีย์ล่วงหน้า 250 บาท
                <br />
            </div>
            <div id="Order" runat="server" visible="false">
                ...
                <div class="row s6 m6 l6 TestBox1">
                    ...
                    <br />
                    ชำระเงินรอบแรก = ค่าสินค้า(บาท) + ค่าขนส่ง (10% ของค่าสินค้า) + 250 บาท(กรณีใช้บริการขนส่งไปรษณีย์)
                    <br />
            ...
            <div id="PI" runat="server" visible="false">
                ...
                <br />
                <div class="row s6 m6 l6 TestBox1">
                    <asp:Label ID="lbPayPI" runat="server"></asp:Label>
                    <br />
                    <br />
                    <span class="bold FontHeader2 orange-text">วิธีคิดค่าใช้จ่าย</span>
                    <br />
                    ชำระเงินรอบแรก = สินค้าฝากจ่าย(บาท) + ค่าขนส่ง (10% ของค่าสินค้า) + ค่าดำเนินการ(<asp:Label ID="lbPI" runat="server"></asp:Label>)
                    <br />
                    ชำระเงินรอบที่ 2 = ค่าขนส่ง (เฉพาะค่าขนส่งที่เกินจาก 10%)                                       
                </div>
                <br />
            ...
            <div id="Trans" runat="server" visible="false">
                <br />
                <div class="row s6 m6 l6 TestBox1">
                    <asp:Label ID="lbPayTrans" runat="server"></asp:Label>
                    <br />
                    <br />
                    <span class="bold FontHeader2 orange-text">วิธีคิดค่าใช้จ่าย</span>
                    <br />
                    ชำระเงินรอบแรก = ค่าขนส่ง (10% ของค่าสินค้า)
                    <br />
                    ชำระเงินรอบที่ 2 = ค่าขนส่ง (เฉพาะค่าขนส่งที่เกินจาก 10%)                                       
                </div>
                <br />
