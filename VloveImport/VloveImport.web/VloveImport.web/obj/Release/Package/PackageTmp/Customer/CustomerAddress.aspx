...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<asp:Button ID="btnAdd2" class="btn waves-effect orange waves-light modal-trigger" runat="server" Text="เพิ่มข้อมูล" OnClick="btnAdd_Click" />--%>
                ...
                <table width="100%">
                    <tr>
                        <td align="center">
                            <asp:GridView ID="gv_cus_address" CssClass="GridStyle" runat="server" AutoGenerateColumns="False" Width="90%" DataKeyNames="CUS_ADD_ID" OnRowCreated="gv_cus_address_RowCreated">
                                <Columns>
