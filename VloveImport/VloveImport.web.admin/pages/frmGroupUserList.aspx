...
<fieldset style="width: 98.5%;">
            ...
            <asp:GridView ID="gv_detail" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="15" Width="100%"
                DataKeyNames="GROUP_ID,GROUP_NAME,GROUP_ROLE,GROUP_REMARK,GROUP_STATUS,CREATE_USER,CREATE_DATE,UPDATE_USER,UPDATE_DATE" OnPageIndexChanging="gv_detail_PageIndexChanging" OnRowCreated="gv_detail_RowCreated" OnRowDataBound="gv_detail_RowDataBound">
                <Columns>
