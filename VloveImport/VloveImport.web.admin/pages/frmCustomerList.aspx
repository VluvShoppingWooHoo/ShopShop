...
<%@ Register src="../UserControls/ucCustomerDetail.ascx" tagname="ucCustomerDetail" tagprefix="uc3" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" BackgroundCssClass="modalBackground"
                PopupControlID="Panel3" TargetControlID="lbl_modal_cus_detail">
            </asp:ModalPopupExtender>
            <asp:Panel ID="Panel3" Height="750px" Width="1000px" runat="server" Style="display: none;">
                <%--Style="display: none;"--%>
                <table width="1000px" style="border-collapse: separate; border-spacing: 0px" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td width="52px" height="43px" style="padding: 0px 0px;" class="trLogin_LEFT"></td>
                        <td align="left" class="trLogin_CENTER" style="padding: 0px 0px;">
                            <div style="margin-left: -40px; margin-top: 10px;">
                                <asp:Label ID="lbl_modal_cus_detail" runat="server" Text="Cusotmer Detail"></asp:Label>
                            </div>
                        </td>
                        <td align="right" width="52px" height="43px" style="padding: 0px 0px;" class="trLogin_RIGHT">
                            <div style="text-align: right; margin-right: 10px; margin-top: 10px;">
                    ...
                    <tr style="background-color: #CFCDCD;">
                        <td style="text-align: center; padding: 0px 0px;" colspan="3">
                            <center>
                            <asp:Panel Width="96%" Height="650px" ID="Panel4" runat="server" BackColor="#FFFFFF">
                                 <div style ="margin-top:20px;">
                                     <uc3:ucCustomerDetail ID="ucCustomerDetail1" runat="server" /> 
                                 </div>              
                            </asp:Panel>
                        </center>
                        </td>
