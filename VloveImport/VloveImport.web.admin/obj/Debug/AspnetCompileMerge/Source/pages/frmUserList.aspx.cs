...
{
    public partial class frmUserList : BasePage
    {
        ...
        public void BindData()
        {
            ...
            try
            {
                ...
                ds = AdBiz.GET_ADMIN_GET_USER(-1, txtusername.Text.Trim(), txtempname.Text.Trim(), Convert.ToInt32(ddl_status.SelectedValue), "BINDDATA");
        ...
        protected void imgBtn_delete_Click(object sender, ImageClickEventArgs e)
        {
            ...
            En.EMP_ID = Convert.ToInt32(GROUP_ID);

            AdminBiz AdBiz = new AdminBiz();
            string Result = AdBiz.ADMIN_INS_USER(En, "DEL");
            if (Result == "")
            {
                BindData();
